...
def booking():
   if request.method =="POST" :
       ...
       Apptime=request.form['appointment time']
       doctor_name=request.form['doctor_name']
       sql = "INSERT INTO appointment (fname,lname,Appdate,Apptime,doctor_name) VALUES (%s, %s, %s,%s,%s)"
       val = (fname,lname,Appdate,Apptime,doctor_name)
       mycursor.execute(sql, val)
       mydb.commit() 
       print(fname,lname,Appdate,Apptime,doctor_name)
       return render_template ("home.html")
   else:   
